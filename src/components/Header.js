          ...
          <div className="rounded-lg p-4 flex items-center justify-between">
            <div className="bg-white rounded-lg p-4">
              <div className="flex flex-row justify-center items-center">
                ...
                <div className="bg-green-500 mr-1 text-white rounded-lg px-3 py-2">
                  <span className="uppercase">Paid</span>
                  <br />
                  €24,000
                </div>
                <div className="bg-slate-500 mr-1 text-white w-28 text-start px-3 py-2 rounded-lg">
                  <span className="uppercase">Pending</span>
                  <br />
                  €41,000
                </div>
                <div className="bg-red-500 w-40 px-3 text-start text-white py-2 rounded-lg">
