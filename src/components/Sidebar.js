  ...
  return (
    <section>
      <div className="w-full absolute -mt-44 h-full">
        <ul className="py-4 px-4 fixed w-full md:w-[270px] h-auto bg-white shadow-lg mt-10 mr-20 mx-8 rounded-xl">
          <div className="bg-white rounded-lg flex pt-4">
          ...
          <li className="flex items-center font-bold hover:bg-violet-100 rounded-md px-6 mt-10 py-4 text-black my-4">
            <img src={HomeIcon} className="mr-4" alt="Home" />
            Home
          </li>
          <li className="flex items-center px-6 font-bold hover:bg-violet-100 rounded-md py-4 text-black my-4">
